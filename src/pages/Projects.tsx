    ...
    <div className="container mx-auto px-4 pt-28 pb-12 space-y-24">
      ...
      <section className="space-y-8">
        <SectionTitle 
          ...
          subtitle="Отзывы о сотрудничестве с KriAl_mebel"
        />
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            {
              quote: "Команда KriAl_mebel превзошла все наши ожидания. Они создали уникальный интерьер для нашего офиса, который отражает ценности нашей компании и создает комфортную атмосферу для работы.",
              author: "Иван Соколов",
              company: "IT Solutions",
              image: testimonialIvanImg
            },
            {
              quote: "Сотрудничество с KriAl_mebel было настоящим удовольствием. Профессиональный подход, внимание к деталям и точное соблюдение сроков – все это делает их идеальным партнером для тендерных проектов.",
