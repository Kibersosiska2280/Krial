    ...
    <div className="container mx-auto px-4 pt-28 pb-12 space-y-24">
      ...
      <section className="space-y-8">
        <SectionTitle 
          ...
          subtitle="Преимущества работы с KriAl"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            {[
              ...
              "Доставка с подъёмом по Пензе и области"
            ].map((item, index) => (
              <motion.div 
                key={index} 
        ...
        <div className="relative">
          ...
          {[
            ...
            },
            {
              step: "05",
              title: "Доставка",
              description: "Доставляем готовый комплект с подъёмом. Пенза и Пензенская область."
            }
          ].map((step, index) => (
            <motion.div 
              key={index}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            },
            {
              ...
              answer: "Да, доставляем по всей России. Подъём и занос — по Пензе и Пензенской области."
            },
          ].map((faq, index) => (
            <motion.div 
              key={index}
